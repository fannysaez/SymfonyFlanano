 ...
 */
final class Version20250316053315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP product_id');
    }
}
